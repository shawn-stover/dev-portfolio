...
import { Tab , Tabs, Grid, Cell, Card, CardTitle, CardText, CardActions, Button, CardMenu } from 'react-mdl'
    ...
    const toggleCategories = () => {
        if(activeTab === 0) {
            ...
            return(
                <div className='projects-grid'>
                    <Card className='card' shadow={5}>
                        <CardTitle style={{color: '#000000', height: '33vh', background: 'url(https://media.giphy.com/media/0y3wefCTDjA1WdeWft/giphy.gif) center / cover'}}>Final Fantasy 14 Note App</CardTitle>
                        <CardText>
            ...
            return(
                <div className='projects-grid'>
                    <Card className='card' shadow={5}>
                        <CardTitle  style={{color: '#FFFFFF', height: '33vh', background: 'url(https://media.giphy.com/media/MOyHcpdL4zIFf1YUCt/giphy.gif) center / cover'}}>Space Invaders Clone</CardTitle>
                        <CardText>
                            Space Invaders Clone was a personal project I did for skill building after my bootcamp. I am still cleaning up bugs, but the game is functional. You can clone down the repo and run the code in a Development Environment to play the game.
                        </CardText>
                        <CardActions border>
                            <Button colored>
